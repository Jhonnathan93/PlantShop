@if ($paginator->hasPages())
    <nav class="book-pagination__nav" aria-label="{{ __('app.books') }} pagination">
        ...
        <p class="book-pagination__summary">
            {{ __('app.redesign.pagination_results', ['from' => $paginator->firstItem(), 'to' => $paginator->lastItem(), 'total' => $paginator->total()]) }}
        </p>
    </nav>
@endif
